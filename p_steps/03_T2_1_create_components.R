...
for (algo in c("M1","S1","S2","S3","S4","S5","S6")) {
        ...
        for (dr in c("gaba","pregaba","any")) {
                ...
                if (thisdatasource=="UOSL") {
                        ...
                        get(paste0("D3_indication_SAP1_",dr))[stringr::str_detect(indication_code, pattern)  & indication_code_vocabulary=="ICD10",component_B:="epilepsy"]
                        
                        
                        # pattern_base <- paste0("^", c("N88","N07"))
                        # pattern_no_dot <- paste(gsub("\\.", "", pattern_base), collapse = "|")
                        # pattern <- gsub("\\*", ".", pattern_no_dot)
                        # get(paste0("D3_indication_SAP1_",dr))[stringr::str_detect(indication_code, pattern)  & indication_code_vocabulary=="ICPC2",component_B:="epilepsy"]
                        ...
                        pattern_no_dot <- paste(gsub("\\.", "", pattern_base), collapse = "|")
                        pattern <- gsub("\\*", ".", pattern_no_dot)
                        get(paste0("D3_indication_SAP1_",dr))[stringr::str_detect(indication_code, pattern)  & indication_code_vocabulary=="ICD10",component_B:="neurophatic_pain"]
                        
                        
                        # pattern_base <- paste0("^", c("A01","L86"))
                        # pattern_no_dot <- paste(gsub("\\.", "", pattern_base), collapse = "|")
                        # pattern <- gsub("\\*", ".", pattern_no_dot)
                        # get(paste0("D3_indication_SAP1_",dr))[stringr::str_detect(indication_code, pattern)  & indication_code_vocabulary=="ICPC2",component_B:="neurophatic_pain"]
                        ...
                        pattern_no_dot <- paste(gsub("\\.", "", pattern_base), collapse = "|")
                        pattern <- gsub("\\*", ".", pattern_no_dot)
                        get(paste0("D3_indication_SAP1_",dr))[stringr::str_detect(indication_code, pattern)  & indication_code_vocabulary=="ICD10",component_B:="anxiety"]
                        
                        
                        # pattern_base <- paste0("^", c("P01","P02","P74"))
                        # pattern_no_dot <- paste(gsub("\\.", "", pattern_base), collapse = "|")
                        # pattern <- gsub("\\*", ".", pattern_no_dot)
                        # get(paste0("D3_indication_SAP1_",dr))[stringr::str_detect(indication_code, pattern)  & indication_code_vocabulary=="ICPC2",component_B:="anxiety"]
                ...
                #COMPONENT G ------------------
                if (thisdatasource=="THL"  | thisdatasource=="ARS"  | thisdatasource=="SAIL Databank" | thisdatasource=="FISABIO"  | thisdatasource=="FERR") {
