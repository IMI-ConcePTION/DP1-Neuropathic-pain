...
# fwrite(D3_events_DEATH, file=paste0(dirtemp,"D3_events_DEATH.csv"))
D3_PERSONS<-unique(D3_PERSONS)

# Save D3_PERSONS
smart_save(D3_PERSONS, dirtemp, extension="rds")
fwrite(D3_PERSONS, file=paste0(dirtemp,"D3_PERSONS.csv"))
